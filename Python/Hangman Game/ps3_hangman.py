...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while guesses > 0:
        ...
        inputguess = input("Please guess a letter: ")
        ...
        if guessInLowerCase in letters_guessed:
            ...
            output = getGuessedWord(secretWord, letters_guessed)

            if guessInLowerCase in list(secretWord):
                print("Good guess: " + output)
                won = isWordGuessed(secretWord, letters_guessed)
